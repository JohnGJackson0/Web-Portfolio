          ...
          <div className="col-lg-3 col-md-6 col-sm-6">
            <Zoom>
              <div className="box">
                ...
                <p>
                  Have deployed and worked with microservices using AWS Lambda
                  and the serverless Framework. Also have some experience in
                  MERN and other databases or servers in general.
                </p>
              </div>
            </Zoom>
          </div>
            ...
            <Zoom>
              <div className="box">
                ...
                <p>
                  ...
                  clean architecture and discovering technical solutions that
                  meet business needs.
                </p>
              </div>
            </Zoom>
