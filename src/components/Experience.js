          ...
          <Zoom>
            <div className="timeline-content">
              ...
              <p>
                ...
                <br />
                • API Libraries and Firebase Integrations - Successfully
                implement multiple API calls (including elastic search),
                Firebase and authentication library, multiple UI design
          ...
          <Zoom>
            <div className="timeline-content">
              ...
              <p>
                ...
                high velocity in a large collaborative team environment as a
                track lead based on the agile/scrum methodology. Is effective at
                ...
                <br />
                • TDD with JEST RNTL & E2E Detox ect.: Created the
                infrastructure and first unit tests using React Native
                @Testing-Library in the application and completed testing many
                features to 100% coverage. Wrote Testing Architecture documents
                and coached unfamiliar developers on proper testing strategies
                and good practice.
                <br />
                • App Publishing and SVN Github GIT CICD: Works effectively with
                GIT and Github and the MS branching strategy or alternative
                branching strategies; can effectively cherry pick, rebase,
                merge, stash, and git flow.
                <br />
              </p>
            </div>
          </Zoom>
